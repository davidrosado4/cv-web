...
export const experience = [
  ...
  },
  {
    ...
    subtitle: "IT-Risk Consultant / Data Scientist",
    details: [
      "🔹 Assessing and enhancing cybersecurity measures for the Cybersecurity Agency of Catalunya. Managing projects that integrate AI to improve cybersecurity intelligence. Key achievements include:",
      "🤖 Implemented a chatbot using Azure OpenAI and LangChain to assist cybersecurity engineers, improving workflows and operational efficiency.",
      " 📊 Conducted data analysis and visualization of Security Operations Center (SOC) data, providing actionable insights to improve incident response times.",
      " 🛡️ Developed machine learning models within the SOC to significantly reduce the false alarm rate, enhancing overall accuracy in threat detection.",
      " 🌐 Created interactive dashboards for the Cybersecurity Agency of Catalunya's website, effectively presenting SOC data to citizens and raising public awareness."
